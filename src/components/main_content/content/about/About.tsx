...
function About() {
    return (
        <div>
            ...
            <p>I am a software engineer with full stack experience and an artisanal approach to front-end development.</p>
            ...
            <Showcase footnote={ `react-spring: hovering card` } interaction={`Hover`}>
            ...
            <Showcase footnote={ `react-spring: simple transition` }>
                <Transition 
                    images={ [ 
